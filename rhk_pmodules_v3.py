...
def _specs() -> List[Spec]:
    ...
    return [
        ...
        ("P39", 80, lambda ui, d: (_sf(d.get("aorta_asc_mm")) is not None and _sf(d.get("aorta_asc_mm")) >= 45)),
        ("P40", 78, lambda ui, d: _sb(d.get("venous_congestion_flag")) or (_sf(d.get("rap_rest")) is not None and _sf(d.get("rap_rest")) >= 10)),
        ("P41", 76, lambda ui, d: _sb(d.get("transaminases_high"))),
        ("P42", 75, lambda ui, d: ((_sf(ui.get("ferritin")) is not None and _sf(ui.get("ferritin")) < 100) or
                                   (_sf(ui.get("ferritin")) is not None and _sf(ui.get("tsat")) is not None and _sf(ui.get("ferritin")) < 300 and _sf(ui.get("tsat")) < 20))),
        ...
        ("P46", 71, lambda ui, d: (_sf(d.get("bmi")) is not None and _sf(d.get("bmi")) > 30) or _sb(d.get("sleep_apnea_suspected"))),
